...
export default function PaymentStepsLayout({
    children,
  }: Readonly<{
    ...
    return (
        <div className="payment-steps-wrapper">
            <div className="steps">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="224" height="1" viewBox="0 0 224 1" fill="none">
                    <line x1="2.18557e-08" y1="0.749992" x2="224" y2="0.750012" stroke="url(#paint0_linear_253_13395)" strokeWidth="0.5" strokeDasharray="3 3"/>
                    <defs>
